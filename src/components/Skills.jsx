    ...
    <div className="py-20 bg-gray-900">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16" data-aos="fade-up">
          <h2 className="text-3xl md:text-4xl font-bold mb-2">My <span className="text-blue-500">Skills</span></h2>
            ...
            >
              <h3 className="text-xl md:text-2xl font-semibold mb-6 flex items-center">
                <span className="text-blue-500 mr-2">
                  <i className={category.category === "Frontend" ? "fas fa-laptop-code" : 
                              category.category === "Backend" ? "fas fa-server" :
                              category.category === "Mobile" ? "fas fa-mobile-alt" : "fas fa-tools"}></i>
                </span>
